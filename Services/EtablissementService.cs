...
{
    public class EtablissementManagementService : IEtablissementService
    {
        private readonly AleniaContext _context;

        public EtablissementManagementService(AleniaContext context)
        {
            _context = context;
        }
        ...
        public async Task<EtablissementResponseDto?> GetEtablissementByIdAsync(Guid id)
        {
            ...
            return new EtablissementResponseDto
            {
                ...
                DateInscription = etablissement.DateCreation
            };
        }
    ...
    {
        Task<EtablissementResponseDto?> GetEtablissementByIdAsync(Guid id);
        Task<EtablissementResponseDto?> UpdateEtablissementAsync(Guid id, UpdateEtablissementDto updateDto);
    }
}